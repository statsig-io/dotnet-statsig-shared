...
namespace StatsigShared
{
    ...
    public class StatsigUser
    {
        ...
        public Dictionary<string, object> privateAttributes;
        public Dictionary<string, string> customIDs;
        public Dictionary<string, string> statsigEnvironment;
        public Dictionary<string, string>? parsedUA;
        ...
        public StatsigUser GetCopyForLogging()
        {
